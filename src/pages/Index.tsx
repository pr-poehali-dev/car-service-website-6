...
const services = [
  ...
  { icon: "Settings", title: "Развал-схождение", desc: "Компьютерная регулировка углов установки колёс. Экономит топливо и продлевает ресурс резины.", price: "от 1 200 ₽" },
  { icon: "Zap", title: "Электрика", desc: "Диагностика и ремонт электрооборудования, установка дополнительного оборудования.", price: "от 600 ₽" },
