...
const reviews = [
  { name: "Алексей М.", rating: 5, text: "Отличный самосервис! Взял подъёмник, поменял масло и фильтры сам. Всё чисто, удобно, мастер помог советом. Цена огонь!", car: "Toyota Camry", date: "Май 2025" },
  { name: "Марина К.", rating: 5, text: "Заправили кондиционер быстро и по-честному. Объяснили что к чему, не навязывали лишнего. Теперь только сюда!", car: "KIA Sportage", date: "Май 2025" },
  { name: "Дмитрий П.", rating: 5, text: "Сварили выхлопную трубу — аккуратно и быстро. Цена приятно удивила. Мастера знают своё дело, рекомендую!", car: "BMW 3 Series", date: "Май 2025" },
  { name: "Светлана Н.", rating: 5, text: "Воспользовалась самосервисом первый раз — понравилось! Подъёмник удобный, инструмент есть всё что нужно. Сэкономила прилично.", car: "Hyundai Tucson", date: "Май 2025" },
  { name: "Роман В.", rating: 5, text: "Езжу сюда с открытия. Рустам — честный мужик, всегда скажет правду. Самосервис — отдельный респект, нигде такого нет.", car: "Lada Vesta", date: "Май 2025" },
  { name: "Ольга Д.", rating: 5, text: "Сделали полную диагностику перед дальней дорогой. Нашли и заменили изношенные детали. Доехали без проблем!", car: "Nissan X-Trail", date: "Май 2025" },
];

const timeSlots = ["09:00", "09:30", "10:00", "10:30", "11:00", "11:30", "12:00", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30"];
const allServices = ["Шиномонтаж", "Заправка кондиционера", "Замена масла", "Диагностика", "Самосервис", "Тормоза", "Сварка", "Кузовные работы"];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 pt-24 pb-16">
          <div className="max-w-3xl">
            ...
            <div className={`flex flex-wrap gap-10 transition-all duration-700 ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
              ...
              {[
                { num: "2025", label: "год открытия" },
                { num: "2 000+", label: "машин обслужено" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection>
              ...
              <h2 className="text-4xl md:text-5xl font-black mb-6" style={{ fontFamily: "'Oswald', sans-serif" }}>
                С 2025 ГОДА РЯДОМ<br /><span style={{ color: "#E51A1A" }}>С ВАШИМ АВТОМОБИЛЕМ</span>
              </h2>
              <p className="leading-relaxed mb-5" style={{ color: "#BBB" }}>
                Автосервис «У Рустама» открылся 25 мая 2025 года. За это время мы уже обслужили более 2 000 автомобилей и завоевали доверие клиентов честным подходом. Наши мастера постоянно повышают квалификацию и работают с современным диагностическим оборудованием.
              </p>
            ...
            <AnimatedSection delay={150}>
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 rounded-2xl p-6 shadow-2xl" style={{ background: "#E51A1A" }}>
                  ...
                  <div className="text-sm" style={{ color: "rgba(255,255,255,0.8)" }}>машин обслужено</div>
                </div>
